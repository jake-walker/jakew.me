<template>
  <div class="layout">
    <div id="header" class="bg-gray-300 bg-hero-circuit-board">
      <div class="container mx-auto text-center py-10">
        ...
        <ul class="flex justify-center my-2">
          <li class="mx-4" v-for="item in nav" :key="item.name">
    ...
    <div id="footer" class="bg-gray-200">
      <div class="container mx-auto text-center py-2 text-gray-700 text-xs">
        <p>
          ...
          &bull;
          <span class="">
            Powered by <a rel="nofollow noopener noreferrer" target="_blank" href="https://gridsome.org/" class="no-underline hover:underline text-primary">Gridsome</a>, <a rel="nofollow noopener noreferrer" target="_blank" href="https://tailwindcss.com/" class="no-underline hover:underline text-primary">Tailwind CSS</a> and <a rel="nofollow noopener noreferrer" target="_blank" href="https://www.netlify.com/" class="no-underline hover:underline text-primary">Netlify</a>.
            Licensed under the <a rel="nofollow noopener noreferrer" target="_blank" href="https://www.gnu.org/licenses/gpl-3.0.en.html" class="no-underline hover:underline text-primary">GNU GPL v3.0 licence</a> and source code is available on <a rel="nofollow noopener noreferrer" target="_blank" href="https://www.github.com/jake-walker/jakew.me" class="no-underline hover:underline text-primary">GitHub</a>.
          </span>
        </p>
      </div>
    </div>
